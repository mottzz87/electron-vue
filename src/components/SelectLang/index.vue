 ...
 * Author       : Vane
 * Desc         :  
 * Date         : 2021-01-28 19:51:22
 * LastEditors  : Vane
 * LastEditTime : 2021-02-10 23:26:27
 * FilePath     : /src/components/SelectLang/index.vue
 -->
<template>
    <el-dropdown @command="changeLang" placement="bottom-end">
        <span class="dropDown">
